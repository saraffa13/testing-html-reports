// File: src/components/profile/PersonalDetailsCard.tsx
...
const PersonalDetailsCard: React.FC<PersonalDetailsCardProps> = ({ personalDetails, onEdit, isUpdating = false }) => {
  return (
    <Box
      sx={{
        borderRadius: "10px",
