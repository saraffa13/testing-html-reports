// File: src/components/OfficerProfile-subComponents/OfficerVerifiedDocumentsCard.tsx
...
// Props interface
interface OfficerVerifiedDocumentsCardProps {
  documents: {
    aadhaarCard: boolean;
...
const OfficerVerifiedDocumentsCard: React.FC<OfficerVerifiedDocumentsCardProps> = ({ documents, upAndUpTrust }) => {
      ...
      >
        ...
        {documents.educationCertificate && (
          <DocumentCard
            ...
            verified={true}
            image="https://via.placeholder.com/48x48/FF9800/FFFFFF?text=EC"
          />
        )}
        {documents.panCard && (
          <DocumentCard
...
export default OfficerVerifiedDocumentsCard;
