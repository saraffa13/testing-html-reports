// File: src/components/OfficerProfile-subComponents/OfficerContactDetailsCard.tsx
import EditIcon from "@mui/icons-material/Edit";
import { Box, CircularProgress, Divider, IconButton, Typography } from "@mui/material";
import React from "react";

// Props interface
interface OfficerContactDetailsCardProps {
  contactDetails: {
    phoneNumber: string;
...
const OfficerContactDetailsCard: React.FC<OfficerContactDetailsCardProps> = ({
  contactDetails,
  address,
  onEdit,
  isUpdating = false,
  ...
  return (
    ...
    >
      ...
      <Box sx={{ flex: 1 }}>
        ...
        <Box sx={{ mb: "16px" }}>
          <KeyValuePair label="Phone Number" value={contactDetails.phoneNumber} />
...
export default OfficerContactDetailsCard;
