...
import { getTaskTypeIcon, type OfficerTaskType } from "./officer-incident-tasks-types";

// Import the API service
import {
  useTaskDetails,
  type TransformedEvidence,
  type TransformedSubtask,
} from "../../../service/taskDetailsApiService";
...
const getTaskTypeIconFromString = (type: string) => {
  ...
  return getTaskTypeIcon(typeMap[type] || "other");
};
...
const TaskDetailsPage: React.FC = () => {
  ...
  const { data: taskDetails, isLoading, error, isError } = useTaskDetails(taskId || null, !!taskId);
              ...
              <Box sx={{ width: "572px", height: "604px", gap: "16px", display: "flex", flexDirection: "column" }}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      {React.cloneElement(getTaskTypeIconFromString(taskDetails.subtasks[0]?.type || "other"), {
                    ...
                    {taskDetails.subtasks.map((subtask) => (
                      ...
                      >
                        <Box sx={{ width: "180px", display: "flex", alignItems: "center", gap: "8px" }}>
                          ...
                          >
                            {React.cloneElement(getTaskTypeIconFromString(subtask.type), {
